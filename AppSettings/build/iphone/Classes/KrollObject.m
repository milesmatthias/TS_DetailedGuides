...
//@interface AppSettingsObject : NSObject
//@end

@interface AppSettingsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AppSettingsObject class]])
		{
			for (NSString *key in [[(AppSettingsObject*)o modules] allKeys])
			{
