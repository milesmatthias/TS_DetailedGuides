...
// in simulator we redefine to format for AppSettings Developer console
...
{\
	NSString * exceptionName = [@"org.appsettings." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.appsettings";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIAppSettingsNativeItemNone = -1, 
	UIAppSettingsNativeItemSpinner = -2,
	UIAppSettingsNativeItemProgressBar = -3,
	
	UIAppSettingsNativeItemSlider = -4,
	UIAppSettingsNativeItemSwitch = -5,
	UIAppSettingsNativeItemMultiButton = -6,
	UIAppSettingsNativeItemSegmented = -7,
	
	UIAppSettingsNativeItemTextView = -8,
	UIAppSettingsNativeItemTextField = -9,
	UIAppSettingsNativeItemSearchBar = -10,
	
	UIAppSettingsNativeItemPicker = -11,
	UIAppSettingsNativeItemDatePicker = -12,
	
	UIAppSettingsNativeItemInfoLight = -13,
	UIAppSettingsNativeItemInfoDark = -14,
	
	UIAppSettingsNativeItemDisclosure = -15,
	
	UIAppSettingsNativeItemContactAdd = -16
};
