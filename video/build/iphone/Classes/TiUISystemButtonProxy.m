...
MAKE_SYSTEM_PROP(ACTIVITY,UIvideoNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIvideoNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIvideoNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIvideoNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIvideoNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIvideoNativeItemContactAdd);
