...
// in simulator we redefine to format for json Developer console
...
{\
	NSString * exceptionName = [@"org.json." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.json";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIjsonNativeItemNone = -1, 
	UIjsonNativeItemSpinner = -2,
	UIjsonNativeItemProgressBar = -3,
	
	UIjsonNativeItemSlider = -4,
	UIjsonNativeItemSwitch = -5,
	UIjsonNativeItemMultiButton = -6,
	UIjsonNativeItemSegmented = -7,
	
	UIjsonNativeItemTextView = -8,
	UIjsonNativeItemTextField = -9,
	UIjsonNativeItemSearchBar = -10,
	
	UIjsonNativeItemPicker = -11,
	UIjsonNativeItemDatePicker = -12,
	
	UIjsonNativeItemInfoLight = -13,
	UIjsonNativeItemInfoDark = -14,
	
	UIjsonNativeItemDisclosure = -15,
	
	UIjsonNativeItemContactAdd = -16
};
