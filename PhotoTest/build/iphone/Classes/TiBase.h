...
// in simulator we redefine to format for PhotoTest Developer console
...
{\
	NSString * exceptionName = [@"org.phototest." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.phototest";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIPhotoTestNativeItemNone = -1, 
	UIPhotoTestNativeItemSpinner = -2,
	UIPhotoTestNativeItemProgressBar = -3,
	
	UIPhotoTestNativeItemSlider = -4,
	UIPhotoTestNativeItemSwitch = -5,
	UIPhotoTestNativeItemMultiButton = -6,
	UIPhotoTestNativeItemSegmented = -7,
	
	UIPhotoTestNativeItemTextView = -8,
	UIPhotoTestNativeItemTextField = -9,
	UIPhotoTestNativeItemSearchBar = -10,
	
	UIPhotoTestNativeItemPicker = -11,
	UIPhotoTestNativeItemDatePicker = -12,
	
	UIPhotoTestNativeItemInfoLight = -13,
	UIPhotoTestNativeItemInfoDark = -14,
	
	UIPhotoTestNativeItemDisclosure = -15,
	
	UIPhotoTestNativeItemContactAdd = -16
};
