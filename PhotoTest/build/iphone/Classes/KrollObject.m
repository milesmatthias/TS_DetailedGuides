...
//@interface PhotoTestObject : NSObject
//@end

@interface PhotoTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PhotoTestObject class]])
		{
			for (NSString *key in [[(PhotoTestObject*)o modules] allKeys])
			{
