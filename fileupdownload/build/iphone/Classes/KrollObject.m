...
//@interface fileupdownloadObject : NSObject
//@end

@interface fileupdownloadObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[fileupdownloadObject class]])
		{
			for (NSString *key in [[(fileupdownloadObject*)o modules] allKeys])
			{
