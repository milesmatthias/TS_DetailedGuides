...
// in simulator we redefine to format for fileupdownload Developer console
...
{\
	NSString * exceptionName = [@"org.fileupdownload." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fileupdownload";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIfileupdownloadNativeItemNone = -1, 
	UIfileupdownloadNativeItemSpinner = -2,
	UIfileupdownloadNativeItemProgressBar = -3,
	
	UIfileupdownloadNativeItemSlider = -4,
	UIfileupdownloadNativeItemSwitch = -5,
	UIfileupdownloadNativeItemMultiButton = -6,
	UIfileupdownloadNativeItemSegmented = -7,
	
	UIfileupdownloadNativeItemTextView = -8,
	UIfileupdownloadNativeItemTextField = -9,
	UIfileupdownloadNativeItemSearchBar = -10,
	
	UIfileupdownloadNativeItemPicker = -11,
	UIfileupdownloadNativeItemDatePicker = -12,
	
	UIfileupdownloadNativeItemInfoLight = -13,
	UIfileupdownloadNativeItemInfoDark = -14,
	
	UIfileupdownloadNativeItemDisclosure = -15,
	
	UIfileupdownloadNativeItemContactAdd = -16
};
