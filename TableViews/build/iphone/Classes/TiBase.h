...
// in simulator we redefine to format for TableViews Developer console
...
{\
	NSString * exceptionName = [@"org.tableviews." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tableviews";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITableViewsNativeItemNone = -1, 
	UITableViewsNativeItemSpinner = -2,
	UITableViewsNativeItemProgressBar = -3,
	
	UITableViewsNativeItemSlider = -4,
	UITableViewsNativeItemSwitch = -5,
	UITableViewsNativeItemMultiButton = -6,
	UITableViewsNativeItemSegmented = -7,
	
	UITableViewsNativeItemTextView = -8,
	UITableViewsNativeItemTextField = -9,
	UITableViewsNativeItemSearchBar = -10,
	
	UITableViewsNativeItemPicker = -11,
	UITableViewsNativeItemDatePicker = -12,
	
	UITableViewsNativeItemInfoLight = -13,
	UITableViewsNativeItemInfoDark = -14,
	
	UITableViewsNativeItemDisclosure = -15,
	
	UITableViewsNativeItemContactAdd = -16
};
