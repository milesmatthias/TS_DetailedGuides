...
//@interface TableViewsObject : NSObject
//@end

@interface TableViewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TableViewsObject class]])
		{
			for (NSString *key in [[(TableViewsObject*)o modules] allKeys])
			{
