...
// in simulator we redefine to format for Events Developer console
...
{\
	NSString * exceptionName = [@"org.events." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.events";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIEventsNativeItemNone = -1, 
	UIEventsNativeItemSpinner = -2,
	UIEventsNativeItemProgressBar = -3,
	
	UIEventsNativeItemSlider = -4,
	UIEventsNativeItemSwitch = -5,
	UIEventsNativeItemMultiButton = -6,
	UIEventsNativeItemSegmented = -7,
	
	UIEventsNativeItemTextView = -8,
	UIEventsNativeItemTextField = -9,
	UIEventsNativeItemSearchBar = -10,
	
	UIEventsNativeItemPicker = -11,
	UIEventsNativeItemDatePicker = -12,
	
	UIEventsNativeItemInfoLight = -13,
	UIEventsNativeItemInfoDark = -14,
	
	UIEventsNativeItemDisclosure = -15,
	
	UIEventsNativeItemContactAdd = -16
};
