...
// in simulator we redefine to format for audio Developer console
...
{\
	NSString * exceptionName = [@"org.audio." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.audio";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIaudioNativeItemNone = -1, 
	UIaudioNativeItemSpinner = -2,
	UIaudioNativeItemProgressBar = -3,
	
	UIaudioNativeItemSlider = -4,
	UIaudioNativeItemSwitch = -5,
	UIaudioNativeItemMultiButton = -6,
	UIaudioNativeItemSegmented = -7,
	
	UIaudioNativeItemTextView = -8,
	UIaudioNativeItemTextField = -9,
	UIaudioNativeItemSearchBar = -10,
	
	UIaudioNativeItemPicker = -11,
	UIaudioNativeItemDatePicker = -12,
	
	UIaudioNativeItemInfoLight = -13,
	UIaudioNativeItemInfoDark = -14,
	
	UIaudioNativeItemDisclosure = -15,
	
	UIaudioNativeItemContactAdd = -16
};
