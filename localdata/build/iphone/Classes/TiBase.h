...
// in simulator we redefine to format for localdata Developer console
...
{\
	NSString * exceptionName = [@"org.localdata." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.localdata";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIlocaldataNativeItemNone = -1, 
	UIlocaldataNativeItemSpinner = -2,
	UIlocaldataNativeItemProgressBar = -3,
	
	UIlocaldataNativeItemSlider = -4,
	UIlocaldataNativeItemSwitch = -5,
	UIlocaldataNativeItemMultiButton = -6,
	UIlocaldataNativeItemSegmented = -7,
	
	UIlocaldataNativeItemTextView = -8,
	UIlocaldataNativeItemTextField = -9,
	UIlocaldataNativeItemSearchBar = -10,
	
	UIlocaldataNativeItemPicker = -11,
	UIlocaldataNativeItemDatePicker = -12,
	
	UIlocaldataNativeItemInfoLight = -13,
	UIlocaldataNativeItemInfoDark = -14,
	
	UIlocaldataNativeItemDisclosure = -15,
	
	UIlocaldataNativeItemContactAdd = -16
};
