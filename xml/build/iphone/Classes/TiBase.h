...
// in simulator we redefine to format for xml Developer console
...
{\
	NSString * exceptionName = [@"org.xml." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.xml";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIxmlNativeItemNone = -1, 
	UIxmlNativeItemSpinner = -2,
	UIxmlNativeItemProgressBar = -3,
	
	UIxmlNativeItemSlider = -4,
	UIxmlNativeItemSwitch = -5,
	UIxmlNativeItemMultiButton = -6,
	UIxmlNativeItemSegmented = -7,
	
	UIxmlNativeItemTextView = -8,
	UIxmlNativeItemTextField = -9,
	UIxmlNativeItemSearchBar = -10,
	
	UIxmlNativeItemPicker = -11,
	UIxmlNativeItemDatePicker = -12,
	
	UIxmlNativeItemInfoLight = -13,
	UIxmlNativeItemInfoDark = -14,
	
	UIxmlNativeItemDisclosure = -15,
	
	UIxmlNativeItemContactAdd = -16
};
